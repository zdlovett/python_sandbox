...
Target class added by Zach Lovett for showing output from a radar module
...
class Cube:
    def __init__(self, s=1, o=Point3D()):
        self.scale = s
        self.origin = o
        self.vertices = [
    ...
    def project(self, screen_width, screen_height, fov, viewer_distance):
        ...
        for v in self.vertices:
            p = v.project(screen_width, screen_height, fov, viewer_distance)
            projected.append(p)
        #return a list of verticies
        return projected
